...
export const api = createApi({
  ...
  tagTypes: ['Auth', 'Users', 'Patients', 'Diets', 'Meals', 'Menu', 'FoodOrders', 'Kitchen', 'Inventory', 'Billing', 'Reports', 'Notifications', 'Feedback'],
  endpoints: (builder) => ({
    ...
    updateFoodOrderStatus: builder.mutation({ query: ({ id, status, note, paymentReceived }) => ({ url: `/menu/orders/${id}/status`, method: 'PATCH', body: { status, note, paymentReceived } }), invalidatesTags: ['FoodOrders', 'Billing', 'Notifications'] }),
